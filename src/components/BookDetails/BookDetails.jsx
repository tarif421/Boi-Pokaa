...
import { addToStoredDB } from "../../Utility/AddToDb/ksx";
  ...
  return (
    <div className="my-10 flex justify-center ">
      ...
      <div>
        ...
        <p>
          Number of page: <span className="font-bold ml-10">{totalPages}</span>
        </p>
        <p>
          Publisher: <span className="font-bold ml-23">{publisher}</span>
        </p>
        <p>
          Number of page: <span className="font-bold ml-10">{totalPages}</span>
        </p>
        <p>
          Year of Publishig:{" "}
          <span className="font-bold ml-10">{yearOfPublishing}</span>
        </p>
        <p>
          Rating: <span className="font-bold ml-28">{rating}</span>
        </p>
